...
class DashboardListView(LoginRequiredMixin, ListView):
    ...
    def post(self, *args, **kwargs):
        ...
        Esta função trata do upload de um arquivo CSV, cria uma nova tarefa
        associado ao usuário e ao processo selecionado,
        e atribui um robô para a tarefa
        se possível. Se nenhum robô estiver disponível, ele permite
        a tarefa de verificar robôs.

        Retorna:
        HttpResponse: Redireciona para a página de tarefas após o processamento.
        """
        if self.request.method == 'POST':
            # Implementar a lista para selecionar o processo #
